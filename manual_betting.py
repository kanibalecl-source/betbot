...
def add_manual_bet(
    ...
    cur = conn.execute(
        ...
        (
            now_text(),
            now_text(),
            str(_pick_value(pick, "fixture_id", "id")),
            str(_pick_value(pick, "odds_event_id", "event_id")),
            str(_pick_value(pick, "mecz", "match")),
            str(_pick_value(pick, "liga", "league")),
            str(_pick_value(pick, "country")),
            str(_pick_value(pick, "home_team", "home")),
            str(_pick_value(pick, "away_team", "away")),
            str(_pick_value(pick, "match_date", "date")),
            str(_pick_value(pick, "market", "typ")),
            _to_float(_pick_value(pick, "kurs_buk", "odds")),
            _to_float(_pick_value(pick, "edge")),
            _to_float(_pick_value(pick, "confidence", "prawd_final")),
            market,
