...
@media(max-width:760px){[data-testid="stSidebar"],[data-testid="stSidebar"][aria-expanded="false"]{display:block!important;visibility:visible!important;transform:translateX(0)!important;width:220px!important;min-width:220px!important;max-width:220px!important;flex:0 0 220px!important}.block-container{padding:0 10px 18px!important}.ui-topbar{margin:0 -10px 14px;padding:0 14px;height:72px}.ui-heading h1{font-size:19px}.ui-heading p,.ui-date{display:none}.ka-grid{grid-template-columns:1fr!important}.ka-page-banner,.ka-page-banner.ka-image-banner{height:92px!important}.ka-brand-banner.ka-full-graphic-banner{height:92px!important;min-height:92px!important}.ka-brand-banner.ka-readable-banner{height:92px!important;min-height:92px!important;grid-template-columns:minmax(280px,1fr) minmax(180px,.75fr)!important}.ka-rb-brand{padding:8px 12px;gap:10px}.ka-readable-banner .ka-rb-logo{width:58px!important;height:58px!important;min-width:58px!important;max-width:58px!important}.ka-rb-wordmark strong{font-size:23px}.ka-rb-wordmark span{font-size:8px}.ka-rb-wordmark small{font-size:6px}.ka-rb-chart,.ka-rb-chart svg{height:92px!important}}
</style>
"""
