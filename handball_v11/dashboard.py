"""Read-only presentation snapshot for the handball web panel."""
...
DASHBOARD_SCHEMA_VERSION = "betbot.handball.dashboard.v11.0"
...
def load_handball_dashboard(
    ...
    *,
    ...
    return {
        ...
        "volleyball_data_modified": bool(
            health.get("volleyball_data_modified", False)
        ),
    }
