...
FINISHED_STATUSES = {"FT", "AW", "AET", "AP", "WO", "ENDED", "CLOSED"}
VOID_STATUSES = {
...
class HandballGame:
    ...
    @classmethod
    def from_api(cls, payload: dict[str, Any]) -> "HandballGame":
        ...
        return cls(
            ...
            home_goals=_integer(home_score),
            away_goals=_integer(away_score),
            raw=payload,
        )
