...
class MLTrainingPipeline:
    ...
    DEFAULT_FEATURES = [
        "probability", "home_xg", "away_xg", "xg_diff", "total_xg",
        "data_quality", "tempo", "home_form", "away_form", "confidence",
    ...
    def _normalize_row(self, r: Dict[str, Any], require_target: bool = True) -> Dict[str, Any]:
        ...
        out = {
            ...
            "home_rest_days": _num(r.get("home_rest_days"), 0.0),
            "away_rest_days": _num(r.get("away_rest_days"), 0.0),
            # Market fields remain available for diagnostics, never as model
            # inputs in the V12 feature list.
